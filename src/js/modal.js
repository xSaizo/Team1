...
(() => {
  const refs = {
    openModalBtn: document.querySelector('[data-modal0-open]'),
    closeModalBtn: document.querySelector('[data-modal0-close]'),
...
(() => {
  const refs = {
    openModalBtn: document.querySelector('[data-modal7-open]'),
    closeModalBtn: document.querySelector('[data-modal7-close]'),
